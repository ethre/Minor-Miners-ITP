...
<html>
    ...
    <body style="cursor: url('img/pickCursor.png'), auto;">
        <script>
            ...
            var score = 0;/* this var is the score */
            var b = 1;
            var c = 1;
            var d = 1;
            var e = 1;
    		...
    		<nav class="cd-main-nav-wrapper noselect">
    			<ul class="cd-main-nav">
    				...
    				<li style="font-family: 'Press Start 2P', cursive; color: #fff;">
    					...
    					<a onclick="menuNav();" href="#0" class="cd-subnav-trigger"><span class="noselect">Marketplace</span></a>
    
    					<ul>
    						<li class="go-back"><a href="#0">Menu</a></li>
    						<li><a style="font-family: 'Sigmar One', cursive; font-size: 25px; cursor: url('img/pickCursor.png'), auto;" onclick="menuNav();" class="cd-bouncy-nav-trigger" href="#0"><span class="noselect">Upgrades</span></a></li>
    		...
    		<div class="cd-bouncy-nav-modal noselect">
            	<nav>
            		...
            		<ul class="cd-bouncy-nav upgradeCirc">
            		    ...
            		    <h1 class="text-center autoUp" style="font-family: 'Press Start 2P', cursive; color: #fff; font-size: 15px; padding-bottom: 5px;">(Costs will be tweaked to be higher than clicker upgrades) </h1>
            			<li class="upgrade1" style="color: #fff;"><a style="font-family: 'Sigmar One', cursive; font-size: 18px;" onclick="up1play(); upg1time(); onClick();" href="#0">Regular Miner </br><span style="font-family: 'Poppins', sans-serif; font-size: 15px;" id="c1">Cost: 10</span> <span style="font-family: 'Poppins', sans-serif; font-size: 15px;" id="mini">Owned: 0</span> </a></li>
                ...
                <div class="row">
                    <div id="col1" class="col-md-4">
                        ...
                        <div class="noselect" style="height: 10%; width: 75%; background-color: rgba(0, 0, 0, 0.5); position: relative; top: 15px; left: 15%; border-radius: 5px;">
                            ...
                            <p style="color:white"id="achieve">Get 11+ for achievement here</p>
                        </div>
                        <!--onclick="increase()" calls function to increment by 1-->
                        <figure>
                            <button style="cursor: url('img/pickCursor.png'), pointer;" onclick="clickPlay(); increase(); achievement1(); achievement2();" class="button clicker"></button>
                        </figure>
                        ...
                        <div id="transformDiv">
                            ...
                            <iframe width="100%" height="350" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/167323338&amp;color=7e4d7e&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false"></iframe>
                        </div>
                    </div>
                    <div id="col2" class="col-md-8" style="background-image: url('img/caveBack.png'); background-repeat: repeat;">
                        <div style="margin-left: -10px; margin-right: -20px;" id="caveTop"></div>
                          <!-- <iframe width="20%" height="350" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/167323338&amp;color=7e4d7e&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false"></iframe> -->
                        <div class="noselect" style="height: 100px; width: 99%; background-image: url('img/platform.png'); background-repeat: repeat-x; background-position: center bottom; position: relative; bottom: 100px; left: ;border-radius: 5px; padding: 5px;">
                            <h1 style="font-family: 'Sigmar One', cursive; font-size: 35px; color: #fff;">Miners Appear Here</h1>
                        </div>
