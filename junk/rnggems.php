<html>
    ...
    <script>
        ...
        $('.a5').animate({ top: newq[0], left: newq[1] }, speed, function(){
        spawnFirstGem();
        });
        ...
        $('.a6').animate({ top: newq[0], left: newq[1] }, speed, function(){
        spawnFirstGem();
        });
      ...
      */
       ...
       function calcSpeed(prev, next) {
        ...
        return speed;
         ...
         <body onload="spawnFirstGem(); spawnSecondGem(); spawnThirdGem(); spawnFourthGem(); spawnFifthGem(); spawnSixthGem();">
