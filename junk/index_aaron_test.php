<!--This enables us to use php sessions-->
<?php
session_start();
?>
<!DOCTYPE html>
                ...
                <div class="row">
                    <div id="col1" class="col-md-4">
                        ...
                        <div class="noselect" style="height: 10%; width: 75%; background-color: rgba(0, 0, 0, 0.5); position: relative; top: 15px; left: 15%; border-radius: 5px;">
                            <img src="img/coin2.gif" style="position: relative; top: 3px; padding-right: 5px;"><span style="color: #FFF146; font-family: 'Lobster', cursive; font-size: 30px; line-height: 40px;">Gold: <span style="color: #fff;"class="text-center" id="Test">Click icon to start..</span></span>
                            </br>
                            <span id="cps" style="font-family: 'Press Start 2P', cursive; color: #fff; font-size: 15px; ">CPS: 1</span>
                            <br />
                            <span><button onclick = "cloneScore();" value="click2clone">Finish and add score to database</button></span>
                            
                            <!--<form method="get" action="index_aaron_test.php">
                                <span><input type="submit" value="Retrieve from db" name="getscore"/></span>
                            </form>-->
                        ...
                        <figure>
                            <button id="clickBtn" style="cursor: url('img/pickCursor.png'), pointer;" onclick="clickPlay(); increase(); achievement1(); achievement2();" class="button clicker"></button>
...
?>
                    ...
                    <div id="col2" class="col-md-8" style="background-image: url('img/caveBack.png'); background-repeat: repeat;">
                        ...
                        <div class="noselect" style="height: 100px; width: 99%; background-image: url('img/platform.png'); background-repeat: repeat-x; background-position: center bottom; position: relative; bottom: 100px; left: ;border-radius: 5px; padding: 5px;">
                            ...
                            <!--uses php session to access current users(session) email address-->
                            <h1 style="font-family: 'Sigmar One', cursive; font-size: 35px; color: #fff;"><?php echo "Welcome " . $_SESSION["mail"] . ".";?></h1>
                        </div>
        ...
        <script type="text/javascript">var score=parseInt("<?php echo $user_gold;?>"); var b=parseInt("<?php echo $user_au1;?>"); var c=parseInt("<?php echo $user_au2;?>");var d=parseInt("<?php echo $user_au3;?>");var curs1Own = parseInt("<?php echo $user_mu1;?>");var curs2Own = parseInt("<?php echo $user_mu2;?>");var curs3Own = parseInt("<?php echo $user_mu3;?>");var clickNum = parseInt("<?php echo $user_cps;?>");var incr1 = parseInt("<?php echo $user_incr;?>");</script>
        <script src="js/game_logic_aaronTest.js"></script>
    </body>
</html>
